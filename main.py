...
class RideBookingApp:
    def __init__(self, root):
        ...
        self.destinations = {
            ...
            ("Marikina", "Quezon City"): 8.4,
            ("Muntinlupa", "Las Piñas"): 10.0,
            ("Parañaque", "Pasay"): 9.2,
            ("Valenzuela", "Caloocan"): 6.3
        }
    ...
    def set_theme(self):
        ...
        if self.is_dark:
            ...
            self.style.map("TCombobox", fieldbackground=[("readonly", "#3e3e3e")], foreground=[("readonly", "white")])
            ...
            self.style.configure("Treeview.Heading", background="#444", foreground="white")
        else:
    ...
    def update_distance(self, event=None):
        ...
        if distance is not None:
            ...
            # No preset distance, allow manual entry
            self.distance_var.set("")
